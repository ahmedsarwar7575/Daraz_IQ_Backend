...
const oauthRoutes = require('./features/oauth')
const settingsRoutes = require('./features/settings')
const contactRoutes = require('./features/contact')

const app = express()

app.disable('x-powered-by')
if (env.contact.trustProxyHops) app.set('trust proxy', env.contact.trustProxyHops)
app.use(cors())
